...
const rows = [
  {
    label: "役務提供事業者",
    value: "エルタウン町内会",
    note: "検証用の架空団体名です。本番ではStripeへ登録した団体の正式名称を表示します。",
  },
  {
    label: "運営責任者",
    value: "検証用責任者",
  ...
  },
  {
    ...
    note: "本番では確実に連絡できる団体窓口を表示します。",
  },
  {
    label: "メールアドレス",
    value: "検証用のため掲載していません",
    note: "本番では会費に関する問い合わせを受け付ける団体窓口を表示します。",
  },
  {
    label: "役務の内容",
    value: "町内会・自治会の年度会費",
    note: "地域活動、情報提供および団体運営に充てる年度会費の受付を想定したテンプレートです。",
  },
  {
    label: "会費",
  ...
  {
    label: "申込期限",
    value: "団体が会費画面または会員向け案内で指定する期日まで",
  },
  {
    label: "キャンセル・返金",
    value: "決済後の会費は、二重払い・誤請求など団体が認める場合を除き、原則として返金しません。",
    note: "返金が必要な場合は団体窓口へご連絡ください。本番では各団体が定めた規約を表示します。",
  },
  {
    label: "決済の安全性",
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.notice} aria-label="検証用ページについて">
        ...
        <p>
          エルタウン町内会は検証用の架空団体です。実在する団体・人物・連絡先とは関係ありません。
      ...
      <section className={styles.flow} aria-labelledby="payment-flow-heading">
        ...
        <ol>
          ...
          <li><span>2</span><strong>本ページで団体情報と返金条件を確認</strong></li>
      ...
      <footer className={styles.footer}>
        <p>本番公開前に、団体の正式名称・責任者・所在地・連絡先・会費・返金条件を必ず確認します。</p>
