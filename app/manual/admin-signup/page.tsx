...
export const metadata: Metadata = {
  ...
  description: "町内会・自治会の代表役員が、el-townへ町内会・自治会と代表者アカウントを新規登録する手順です。",
};
...
export default function AdminSignupManualPage() {
  return (
    <OnboardingGuide
      ...
      time="約5分"
      preparation={[
        { icon: "fas fa-people-roof", title: "町内会・自治会の基本情報", text: "正式名称・郵便番号・おおよその会員世帯数" },
      ...
      steps={[
        {
          ...
          text: "el-townのトップ画面で「役員の方」を押し、役員ログイン画面を開きます。すでに登録済みの町内会・自治会へ参加する場合は、この新規申し込みではなく代表役員からの招待URLを使用してください。",
          visual: (
            <ActualScreenImage
        ...
        },
        {
          ...
          text: "役員ログイン画面の下にある「新規の町内会・自治会を登録する」を押します。町内会・自治会をはじめて登録する代表役員だけがこの操作を行います。",
          visual: (
            <ActualScreenImage
        ...
        {
          title: "町内会・自治会の基本情報を入力する",
          text: "町内会・自治会名、郵便番号、会員世帯数、申し込む方の役職を入力します。町内会・自治会名は略称ではなく、普段使用している正式名称を入力してください。",
          visual: (
            <ActualScreenImage
        ...
        },
        {
          ...
          text: "町内会・自治会名・メールID・パスワードを確認し、「登録して開始」を押します。登録した町内会・自治会の管理画面が表示されたら、新規申し込みは完了です。",
          visual: (
            <ActualScreenImage
              src="/manual/screens/admin-signup-bottom.png"
