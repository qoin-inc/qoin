...
export const metadata: Metadata = {
  ...
  description: "エルタウン町内会を例に、基本情報、会員、会費、システム利用料、役員、Stripe連携の操作を説明します。",
};
    ...
    <ManualAccessGate>
      <OnboardingGuide
        ...
        preparation={[
          ...
          { icon: "fas fa-shield-halved", title: "操作できる役員", text: "保存・招待・請求前に担当と内容を確認" },
        ]}
        steps={[
          {
            title: "管理トップから「基本機能」を開く",
            text: "LINEリッチメニューの「役員の方」からログインし、管理トップの「基本機能」を押します。基本情報、会員管理、会費管理、システム利用料、役員管理、Stripe連携が表示されるので、操作したい項目の「開く」を押してください。",
            points: [
              "画面上部の団体名が「エルタウン町内会」になっていることを確認します。",
