    ...
    <ManualAccessGate scope="admin">
      <OnboardingGuide
        ...
        steps={[
          ...
          {
            title: "会員管理にて会員名簿を管理",
            text: "会員がLineから世帯情報を照合しel-townを利用するため、町内会・自治会の会員名簿をCSV取込みで取込んでおきます。取込みする会員名簿CSVの項目はCSV出力し確認してください。郵便番号、住所２は番地まで、住所３はアパート・マンション名部屋番号とし作成してください。家族は世帯主の情報で登録が可能となりますので、Lineから登録になりますので、特に退会などの希望がなければそのまま名簿に記載のままにしてください。",
            points: [
              "家族名簿のうち世帯主または家族がLINE連携した世帯がシステム利用料の対象となります。",
