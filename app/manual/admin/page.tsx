      ...
      <OnboardingGuide
        ...
        steps={[
          ...
          },
          {
            title: "会費管理",
            subtitle: "会員への会費請求登録",
            text: "会費請求設定にて対象年度、請求額を入力し、対象会員を選び、「請求額を設定」を押下すると会員に会費が設定されます。会費は「全会員世帯」「会費一覧で選択」で個別設定し、追加された会員は「請求未設定」を選んで設定してください。オンラインで支払われた会費は入金確定後にStripe入金へ自動反映されます。",
            points: [
              "退会済み会員の会費実績も集計されます。",
