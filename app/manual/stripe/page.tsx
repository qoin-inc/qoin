      ...
      <OnboardingGuide
        ...
        steps={[
          ...
          },
          {
            ...
            visual: <StripeDesktopPreview focus="registration" caption="現在のPC画面：右側の「Stripe登録を開始」で町内会・自治会情報を入力します" />,
          },
          {
            title: "3つの準備確認後に本番登録を開始する",
            text: "「規約・登記上の組織区分」「代表者の本人確認書類」「町内会・自治会が管理する入金先口座」の3項目を実際に準備できた場合だけチェックします。「入力内容を確認してStripe登録を開始」を押すと、別画面でStripeの登録が始まります。",
            points: [
