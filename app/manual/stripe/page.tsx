      ...
      <OnboardingGuide
        ...
        steps={[
          ...
          },
          {
            ...
            text: "会員は会員画面の会費案内から「オンラインで支払う」にて、Stripeの安全な決済画面でクレジットカード、口座振込、PayPay(オプション）を選び支払います。会費管理の会費一覧にオンライン決済にて支払い完了後、自動で入金が反映します。集金の入力やオンライン決済入金後、会員画面には入金額と入金済が表示されます。",
